...
SOURCE = test_progs/sort_search.c
...
VCS = vcs -V -sverilog +vc -Mupdate -line -full64 +vcs+vcdpluson -debug_pp +lint=TFIPC-L +lint=PCWM
...
export CLOCK_PERIOD   = 11	# TODO: You will need to make match SYNTH_CLOCK_PERIOD in sys_defs
